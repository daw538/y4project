...
output = pd.read_csv('~/y4project/data/NGC6819/output_NGC6819.csv', usecols=['ID','Numax', 'Numax_err'])
...
modesID = [pd.read_csv('~/y4project/data/NGC6819/modes_'+str(IDs[i])+'.csv', usecols=['f0', 'f0_err', 'A0'])
...
np.savetxt('ngc6819_notau.csv', params, delimiter=',')
hiers.to_csv('ngc6819_notau_hiers.csv', index=False)

if print_fit == True:
	with open('ngc6819_summ_notau.txt', 'w') as f:
		f.write(summ_notau)
...
no_tau = pd.read_csv('ngc6819_notau.csv', names=['kic', 'dnu', 'numax',
...
df2.to_csv('ngc6819_tau.csv', index=False, header=False)
#np.savetxt('ngc6819_tau.csv', params, delimiter=',')
hiers.to_csv('ngc6819_tau_hiers.csv', index=False)

if print_fit == True:
	with open('ngc6819_summ_tau.txt', 'w') as f:
		f.write(summ_tau)
