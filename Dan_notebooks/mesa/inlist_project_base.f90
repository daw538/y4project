...
&controls
  ...
  ! Log file names - please change appropriately
    star_history_name   = 'Mxxx_Yzzz_Zuuu_mmdd.data'  ! M<mass>_<info>_<date>.data
    profiles_index_name = 'Mxxx_Yzzz_Zuuu_mmdd.index' ! M<mass>_<info>_<date>.index
    profile_data_prefix = 'Mxxx_Yzzz_Zuuu_mmdd_'      ! M<mass>_<info>_<date>_
    profile_data_suffix = '.profile' ! Don't change this

    initial_mass = xxx ! in Msun units
    initial_y = zzzd0 ! initial He composition
    initial_z = vvv   ! initial metallicity
